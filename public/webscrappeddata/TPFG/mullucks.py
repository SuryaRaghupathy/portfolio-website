...
base_url = 'https://www.mullucks.co.uk/search-results-grid/for-sale/in-hertfordshire-and-essex/page-'
...
while True:
    ...
    try:
        # Send a GET request with the User-Agent header and timeout
        ...
        if response.status_code == 200:
            ...
            for div in divs:
                ...
                if a_tag:
                    ...
                    property_response = session.get(property_url, headers=headers, timeout=10)
